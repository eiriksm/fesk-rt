...
describe("FESK real time Test", () => {
  it("should decode audio when recording with fake microphone stream", () => {
    const recordDurationMs =
      Number(Cypress.expose("recordDurationMs")) || 16000;
    ...
    const decodeBufferMs = Number(Cypress.expose("decodeBufferMs")) || 8000;
    const expectedText = Cypress.expose("expectedText") || "test";
    const modulation = Cypress.expose("modulation") || "";
